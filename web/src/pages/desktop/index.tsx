  ...
  return (
    <>
      ...
      <section className="flex-[2] relative flex flex-col box-border h-full my-0 overflow-hidden">
        {!isDesktop && (
          <header className="relative z-10 flex items-center justify-center gap-2 p-4 border-b border-b-gray-200 shadow">
        ...
        <footer
          className={clsx(
            ...
            isDesktop ? 'py-4 pt-2 px-40' : 'px-2 shadow-footer',
          )}
          style={{
            paddingRight:
