        ...
        {activeTab === 'upload' && (
          <div className="flex h-full flex-col">
            <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-6 text-center">
              <UploadIcon size={40} className="mb-4 text-gray-400" />
              <p className="mb-2 text-gray-600">Tap to select files</p>
            ...
            <div className="mt-4 rounded-xl bg-white p-4 shadow-sm">
              <h3 className="mb-2 font-medium">Recent Transfers</h3>
              <div className="space-y-2">
                <MobileTransferItem name="Project.zip" status="Completed" />
                <MobileTransferItem name="Presentation.pdf" status="Failed" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'receive' && (
          <div className="rounded-xl bg-white p-6 shadow-sm">
            ...
            <input
              ...
              className="mb-4 w-full rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
        ...
        {activeTab === 'settings' && (
          <div className="rounded-xl bg-white p-4 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <MobileSettingItem title="Auto-clear" value="24 hours" />

              <div className="space-y-4">
                <h3 className="font-medium">Transfer Mode</h3>
                <div className="space-y-2">
                  <MobileRadioOption label="WebRTC (Direct)" checked={true} />
                  <MobileRadioOption
...
const MobileFileCard: FC<{
  ...
  return (
    <div className="flex items-center rounded-lg bg-gray-50 p-3">
      <div className="mr-3 rounded-lg bg-white p-2 shadow-sm">{getIcon()}</div>
