...
>(({ className, ...props }, ref) => {
    ...
    useMeasureSize(textareaRef, scrollerRef);
    useEffect(() => {
    ...
    return (
        <section
            className={clsx('input-gradient relative w-full', className)}
            {...props}
        >
            ...
            <div className="w-full rounded-2xl border border-gray-200 p-4">
                <div className="p-3 pr-0">
                    <div
                        ref={scrollerRef}
                        className="relative h-full w-full overflow-hidden transition-[height]"
                    >
                        <div className="scrollbar-present relative h-auto max-h-[300px] w-full overflow-x-hidden overflow-y-auto leading-[0]">
                            <textarea
                                ref={composedRefs}
                                value={text}
                                onKeyUp={handlers.keyup}
                                onChange={handlers.change}
                                className="h-full w-full resize-none appearance-none overflow-hidden border-none text-sm shadow-none outline-0 outline-none"
                                placeholder={i18n._(
                ...
                <div className="flex items-center justify-between">
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            variant="ghost"
                            size="icon"
                            onClick={handlers.openVoiceRecorder}
                        >
                            <MicIcon className="h-4 w-4 stroke-gray-600" />
                        </Button>
                    </div>
                    <div className="mr-2 flex gap-2">
                        ...
                        >
                            <span className="mr-2 box-content leading-none text-white">
                                {transmitting ? (
                                    <>
