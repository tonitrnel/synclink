                    ...
                    >
                        ...
                        <div className="audio-bar-container">
                            <div
                                ...
                                style={{
                                    width: controllers.getWidth(state.loaded),
                                }}
                            />
                            <div
                                className="audio-played"
                                style={{
                                    width: controllers.getWidth(state.played),
                                }}
                            />
                        </div>
                    </div>
