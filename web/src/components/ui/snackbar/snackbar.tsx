                    ...
                    <div className="mx-1 flex-1">
                        {title ? (
                            <>
                                ...
                                <p className="leading-normal text-gray-200">
                                    {message}
                                </p>
                            </>
                        ) : (
...
export const SnackbarContainer: FC<{
    ...
    return (
        <ol className="pad:w-auto pointer-events-none fixed top-8 left-[50%] z-[9999] box-border flex w-[80vw] translate-x-[-50%] flex-col-reverse items-center gap-2">
